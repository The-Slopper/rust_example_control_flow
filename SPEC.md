...
| Field | Value |
|---|---|
| Repository | `rust_example_control_flow` |
| Language | Rust (Cargo) |
| Versao | 1.0 |
| Status | Ativo |
...
Didactic example of control flow and language structures. This document describes requirements, architecture, and acceptance criteria.
