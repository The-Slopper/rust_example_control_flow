# Especificacao Tecnica — Control Flow

| Campo | Valor |
|---|---|
| Repositorio | `rust_example_control_flow` |
...
Exemplo didatico de fluxo de controle e estruturas da linguagem. Este documento descreve requisitos, arquitetura e criterios de aceite.
